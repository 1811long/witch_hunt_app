 ...
 * demandés par la carte DuckingStool
 * @author Tran Le Vu Long
 */
public class DuckingStoolUI extends WindowInputUI{
    private Joueur joueurChoisi = null;

    /**
     * Constructor de la fenêtre DuckingStool UI
     * @param effet
     */
    public DuckingStoolUI(String effet){
        super(effet);
