...
/**
 * Cette classe représente une fenêtre qui permet au joueur de saisir
 * un joueur à accuser
 * @author Tran Le Vu Long
 */
public class AccuserUI extends WindowInputUI{
    /**
     * Représente le joueur choisi pour accuser
     */
    ...
    /**
     * Constructor de la fenêtre AccuserUI
     */
    public AccuserUI(){
        super();
    ...
    /**
     * Méthode permet d'ajouter Controller ou une classe implémentant interface ActionListener à cette fenêtre
    ...
    /**
     * Méthode qui génère la formulaire pour choisir un joueur à accuser
     */
