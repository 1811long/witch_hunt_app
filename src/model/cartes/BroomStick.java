...
/**
 * Cette classe représente la carte Broomstick du jeu Witch Hunter
 * 
...
public class BroomStick extends RumourCarte {
	/**
	 * Cette méthode est le constructeur de la carte Broomstick. On utilise les
	...
	/**
	 * Permet d'utiliser l'effet Hunt de la carte. Consiste à choisir le prochain
	 * joueur qui jouera au prochain tour
	 * 
	 * @param utilisateur L'utilisateur de la carte
	 * @param joueurSuivant Le joueur suivant souhaité
	 */
	...
	/**
	 * Permet d'utiliser l'effet Witch de la carte. Consiste à prendre la main au
	 * prochain tour
	 * 
	 * @param utilisateur L'utilisateur de la carte
	 */
